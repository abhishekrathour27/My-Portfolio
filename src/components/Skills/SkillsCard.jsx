...
export default function SkillsCard({ item }) {
    return (
        <div className='bg-[#020618] h-[40vh] w-[25vw] flex flex-col items-center py-5 gap-10 rounded-lg'>
            <h1 className='font-semibold text-xl'>{item.title}</h1>
            <div className='flex flex-wrap gap-5 items-center justify-center w-[22vw]'>
                {
